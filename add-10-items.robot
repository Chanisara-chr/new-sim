...
Entry Website
    ...
    ...    Wait Until Page Contains    Welcome To Selling Invoice Management System 
...
Verify 9 Items
    [Documentation]    METHOD 1 - Loop through CSV data and process each invoice item using dictionaries
